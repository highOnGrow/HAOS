...
--
-- Host: localhost    Database: invernadero2
-- ------------------------------------------------------
...
--
-- Table structure for table `cActuadores`
--

DROP TABLE IF EXISTS `cActuadores`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cActuadores` (
  `idcactuadores` int(11) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(45) DEFAULT NULL,
  `tipo` varchar(45) DEFAULT NULL,
  `idConexion` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idcactuadores`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `cActuadores`
--

LOCK TABLES `cActuadores` WRITE;
/*!40000 ALTER TABLE `cActuadores` DISABLE KEYS */;
/*!40000 ALTER TABLE `cActuadores` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `pCultivoActuador`
--

DROP TABLE IF EXISTS `pCultivoActuador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `pCultivoActuador` (
  `idtCultivoActuador` int(11) NOT NULL AUTO_INCREMENT,
  `idCultivo` int(11) DEFAULT NULL,
  `idActuador` int(11) DEFAULT NULL,
  PRIMARY KEY (`idtCultivoActuador`),
  KEY `fk_ca_actuador_idx` (`idActuador`),
  KEY `fk_ca_cultivo_idx` (`idCultivo`),
  CONSTRAINT `fk_ca_actuador` FOREIGN KEY (`idActuador`) REFERENCES `cActuadores` (`idcactuadores`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ca_cultivo` FOREIGN KEY (`idCultivo`) REFERENCES `tCultivo` (`idtCultivo`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `pCultivoActuador`
--

LOCK TABLES `pCultivoActuador` WRITE;
/*!40000 ALTER TABLE `pCultivoActuador` DISABLE KEYS */;
/*!40000 ALTER TABLE `pCultivoActuador` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tAlarmas` (
  ...
  KEY `fk_alarma_Actuador_idx` (`idActuador`),
  ...
  CONSTRAINT `fk_alarma_Actuador` FOREIGN KEY (`idActuador`) REFERENCES `cActuadores` (`idcactuadores`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
-- Table structure for table `tLogActuador`
--

DROP TABLE IF EXISTS `tLogActuador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tLogActuador` (
  `idtLogActuador` int(11) NOT NULL AUTO_INCREMENT,
  `idActuador` int(11) DEFAULT NULL,
  `hora` datetime DEFAULT NULL,
  `accion` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`idtLogActuador`),
  KEY `fk_la_Actuador_idx` (`idActuador`),
  CONSTRAINT `fk_la_Actuador` FOREIGN KEY (`idActuador`) REFERENCES `cActuadores` (`idcactuadores`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tLogActuador`
--

LOCK TABLES `tLogActuador` WRITE;
/*!40000 ALTER TABLE `tLogActuador` DISABLE KEYS */;
/*!40000 ALTER TABLE `tLogActuador` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `tTemporizador`
--

DROP TABLE IF EXISTS `tTemporizador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tTemporizador` (
  `idtTemporizador` int(11) NOT NULL AUTO_INCREMENT,
  `idActuador` int(11) DEFAULT NULL,
  `idLector` int(11) DEFAULT NULL,
  `fechaInicio` datetime DEFAULT NULL,
  `cronEjecucion` varchar(45) DEFAULT NULL,
  `fechaFin` datetime DEFAULT NULL,
  PRIMARY KEY (`idtTemporizador`),
  KEY `fk_tem_actuador_idx` (`idActuador`),
  KEY `fk_tem_lector_idx` (`idLector`),
  CONSTRAINT `fk_tem_actuador` FOREIGN KEY (`idActuador`) REFERENCES `cActuadores` (`idcactuadores`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tem_lector` FOREIGN KEY (`idLector`) REFERENCES `tLector` (`idtLector`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tTemporizador`
--

LOCK TABLES `tTemporizador` WRITE;
/*!40000 ALTER TABLE `tTemporizador` DISABLE KEYS */;
/*!40000 ALTER TABLE `tTemporizador` ENABLE KEYS */;
UNLOCK TABLES;
