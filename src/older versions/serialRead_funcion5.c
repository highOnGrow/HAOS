...
int main (){
  ...
  struct opt_range or;//Optimal values range retrived from DB
...
struct opt_range _init_or( MYSQL* conn){
  struct opt_range or;
...
void shuttingdown(int fd, int fd, conn){
